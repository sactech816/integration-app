...
export const freelanceTemplate: Template = {
  id: 'freelance',
  name: 'フリーランス',
  description: '10ブロック構成｜ヒーロー・実績・サービス・お客様の声・料金・リンク',
  category: 'フリーランス',
  icon: 'Laptop',
  recommended: true,
  order: 6,
  ...
  blocks: [
    {
      ...
      type: 'hero_fullwidth',
      data: {
        headline: 'デザインの力で、ビジネスを加速させる。',
        subheadline: 'フリーランス歴8年。100以上のWebサイト・アプリのデザインを手がけてきました。「見た目が良い」だけでなく、「成果が出る」デザインをご提供します。',
        backgroundImage: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?q=80&w=2070&auto=format&fit=crop',
        ctaText: '制作実績を見る',
        ctaUrl: '#portfolio'
      }
    },
        ...
        items: [
          {
            ...
            answer: '基本プランでは2回まで込みです。追加修正は別途お見積りとなります。'
          },
          {
            id: generateBlockId(),
            question: '納期はどのくらいですか？',
            answer: 'LPで約2週間、コーポレートサイトで約1ヶ月が目安です。お急ぎの場合はご相談ください。'
          }
        ]
      }
    },
    ...
    },
    {
      ...
      data: {
        title: 'お気軽にご相談ください',
        description: 'まずはヒアリングから。お見積りは無料です。',

...
export const cafeRestaurantTemplate: Template = {
  id: 'cafe-restaurant',
  name: 'カフェ・飲食店',
  description: '9ブロック構成｜ヒーロー・こだわり・メニュー・画像・マップ・リンク・LINE',
  category: 'カフェ・飲食店',
  icon: 'Coffee',
  recommended: false,
  order: 5,
  ...
  blocks: [
    {
      ...
      type: 'hero_fullwidth',
      data: {
        headline: '日常に、ちょっとした贅沢を。',
        subheadline: '自家焙煎のスペシャルティコーヒーと、毎朝手作りするスイーツ。光あふれる店内で、くつろぎのひとときを。',
    ...
    },
    {
      ...
      data: {
        ...
        description: '新メニュー情報や限定クーポンをお届けします',

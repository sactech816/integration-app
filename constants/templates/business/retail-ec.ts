...
export const retailEcTemplate: Template = {
  id: 'retail-ec',
  name: '物販・EC',
  description: '8ブロック構成｜ヒーロー・こだわり・お客様の声・FAQ・LINE',
  category: '物販・EC',
  icon: 'ShoppingBag',
  recommended: false,
  order: 3,
  ...
  blocks: [
    {
      ...
      type: 'hero_fullwidth',
      data: {
        headline: '自然の美しさを、あなたの日常に。',
        subheadline: '天然石とドライフラワーを使った、世界に一つだけのハンドメイドアクセサリー。素材選びから仕上げまで、すべて手作業で丁寧に制作しています。',
        backgroundImage: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?q=80&w=2070&auto=format&fit=crop',
        ctaText: 'ショップを見る',
        ctaUrl: '#shop'
      }
    },
    ...
    },
    {
      ...
      data: {
        title: '新作をいち早くお届け',
        description: 'LINE登録で最新情報と限定クーポンをお届けします',

    ...
    <div className="border-b border-gray-100 pb-6 last:border-0">
      ...
      {question.type === "text" && (
        <textarea
          ...
          className="w-full border border-gray-300 rounded-lg p-4 h-32 focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition resize-none bg-gray-50 focus:bg-white"

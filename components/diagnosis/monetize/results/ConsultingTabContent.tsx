...
import { Briefcase, Users, Package, Lightbulb, DollarSign, Calendar, Zap, Footprints } from 'lucide-react';
          ...
          <div className="space-y-3 pl-11">
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm text-gray-700">
                <span className="font-medium text-gray-800">対象:</span> {item.targetClient}
              </p>
            </div>
            <div className="flex items-start gap-2">
            ...
            {item.sessionFormat && (
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-gray-700">
                  <span className="font-medium text-gray-800">形式:</span> {item.sessionFormat}
                </p>
              </div>
            )}
            <div className="flex items-start gap-2">
            ...
            {item.firstStep && (
              <div className="bg-emerald-50 rounded-lg p-3 flex items-start gap-2">
                <Footprints className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />

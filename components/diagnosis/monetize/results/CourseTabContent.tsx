...
import { GraduationCap, Users, ListChecks, Lightbulb, DollarSign } from 'lucide-react';
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {item.curriculum.map((module, i) => (
                    <span key={i} className="text-xs px-2.5 py-1 bg-violet-50 text-violet-700 rounded-full border border-violet-200">
                      {i + 1}. {module}
                    </span>
                  ))}
                </div>

...
import YouTubeAnalysisEditor from '@/components/youtube-analysis/YouTubeAnalysisEditor';
...
export default function YouTubeAnalysisPage() {
  ...
  return (
    <>
      ...
      {user ? (
        <YouTubeAnalysisEditor user={user} isAdmin={isAdmin} />
      ) : (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="bg-white rounded-2xl border border-gray-300 shadow-md p-8 max-w-md mx-auto text-center">
            ...
            <p className="text-gray-600 mb-6">YouTube競合分析ツールを利用するにはログインしてください</p>
            <button

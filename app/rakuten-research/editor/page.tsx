...
import RakutenResearchEditor from '@/components/rakuten-research/RakutenResearchEditor';
...
export default function RakutenResearchPage() {
  ...
  return (
    <>
      ...
      {user ? (
        <RakutenResearchEditor user={user} isAdmin={isAdmin} />
      ) : (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="bg-white rounded-2xl border border-gray-300 shadow-md p-8 max-w-md mx-auto text-center">
            ...
            <p className="text-gray-600 mb-6">楽天市場リサーチツールを利用するにはログインしてください</p>
            <button

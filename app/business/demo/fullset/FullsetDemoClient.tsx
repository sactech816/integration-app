...
// フルセット（15ブロック）デモ（参考: https://makers.tokyo/business/L5BNM）
// すべてのブロックを使った完全版ビジネスLP
const demoLP: BusinessLP = {
  id: 'demo-fullset',
  slug: 'demo-fullset',
  title: 'あなたのビジネスを次のステージへ｜ビジネスコンサルティング',
  ...
  content: [
    ...
    // 10. チェックリスト
    {
      ...
      data: {
        ...
        columns: 2,
        items: [
          { id: generateBlockId(), title: '本気で成果を出したい方', description: '' },
          { id: generateBlockId(), title: '一人で悩んでいる方', description: '' },
          { id: generateBlockId(), title: '自己投資を惜しまない方', description: '' },
          { id: generateBlockId(), title: '素直に実践できる方', description: '' },
          { id: generateBlockId(), title: '継続できる方', description: '' },
          { id: generateBlockId(), title: '成長意欲の高い方', description: '' },
        ],
      },
    },
    // 11. FAQ
...
export default function BusinessFullsetDemoPage() {

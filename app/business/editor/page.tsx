...
function BusinessEditorContent() {
  ...
  if (!user) {
    return (
      <>
        <Header setPage={navigateTo} user={null} onLogout={handleLogout} setShowAuth={setShowAuth} currentService="business" />
        <LoginRequired toolName="ビジネスLPメーカー" onLogin={() => setShowAuth(true)} />

  ...
  const faqData = [
    {
      ...
      answer: 'AI生成文はあくまで「たたき台」です。必ずご自身の経験や知見を加えて編集してください。Amazonのガイドラインでは、AI生成コンテンツを利用する場合、人間による編集と監修が求められています。KDLは、その編集作業を効率化するツールとしてご活用ください。'
    },
    {
      question: 'Kindle出版の経験がなくても使えますか？',
      answer: 'はい、全く問題ありません。KDLは初心者の方でも安心してご利用いただけるよう、KDPアカウント開設から出版までの全工程をステップバイステップでガイドします。わからないことがあれば、マニュアルやサポートをご活用ください。'
    },
    {

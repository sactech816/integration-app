...
export const metadata: Metadata = {
  title: 'ファネルメーカー（簡易ファネル構築）【無料】| 集客メーカー',
  description:
    '集客ファネルを無料で構築。既存のLP・診断クイズ・申し込みフォームを繋いで、各ステップのコンバージョン率を可視化して改善に活かせます。',
  keywords: ['ファネル', 'マーケティングファネル', 'コンバージョン', 'CVR', '集客', '無料', '導線設計', 'ファネル構築', 'CVR改善'],
  openGraph: {
  ...
  '@graph': [
    {
      ...
      offers: {
        ...
        price: '3980',
        priceCurrency: 'JPY',
        description: '有料プラン（月額1,980円〜）に含まれる機能',
      },
      featureList: [
        '既存ページをステップとして接続',
        'CVR自動計測',
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: '有料プラン（月額1,980円〜）に含まれる機能です。他の有料プラン機能と合わせてご利用いただけます。',
          },
        },
      ],
    },
...
const faqs = [
  ...
  { q: '無料で使えますか？', a: '有料プラン（月額1,980円〜）に含まれる機能です。他の有料プラン機能と合わせてご利用いただけます。' },
];

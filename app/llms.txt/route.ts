...
- 楽しいエンタメ診断をAIで自動生成
- SNSでシェアされやすいバイラルコンテンツ
- 4つのデザインスタイル対応（ビビッド・キュート・クール・ポップ）

### ファネルメーカー
- URL: ${BASE_URL}/funnel
- 既存のLP・診断クイズ・申し込みフォームを繋いで集客ファネルを構築
- 各ステップのコンバージョン率を可視化して改善に活かせる
- ウォーターフォールチャートで離脱ポイントを分析

### 申し込みフォームメーカー
- URL: ${BASE_URL}/order-form
- 決済機能付きの申し込みフォームを簡単に作成
- Stripe・UnivaPay対応
- セミナー・講座・コンサル申し込みの受付と決済を1つのフォームで完結
...
### どんなコンテンツが作れますか？
診断クイズ、エンタメ診断、プロフィールLP、ビジネスLP、アンケート、セールスレター、予約ページ、ゲーミフィケーション（ガチャ・福引き・スクラッチ等）、ファネル、申し込みフォーム（決済対応）、メルマガ配信が作成できます。

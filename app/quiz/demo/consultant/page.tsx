  ...
  questions: [
    {
      ...
      options: [
        { text: 'まずは徹底的に話を聞く', score: { A: 3, B: 0, C: 1, D: 0 } },
        { text: 'データ分析から課題を特定する', score: { A: 0, B: 3, C: 0, D: 1 } },
        { text: '具体的な行動計画を一緒に作る', score: { A: 1, B: 0, C: 3, D: 1 } },
        { text: 'ベストプラクティスを提示する', score: { A: 0, B: 1, C: 1, D: 3 } },
      ],
    },
    {
      id: 'q2',
      text: 'あなたの専門分野は？',
      options: [
        { text: '組織開発・人材育成', score: { A: 3, B: 0, C: 1, D: 0 } },
        { text: '経営戦略・事業計画', score: { A: 0, B: 3, C: 0, D: 1 } },
        { text: 'マーケティング・集客支援', score: { A: 0, B: 1, C: 3, D: 1 } },
        { text: '業務改善・DX推進', score: { A: 0, B: 1, C: 1, D: 3 } },
      ],
    },
    {
      id: 'q3',
      ...
      options: [
        { text: 'クライアントとの信頼関係', score: { A: 3, B: 0, C: 1, D: 0 } },
        { text: '論理的で説得力のある提案', score: { A: 0, B: 3, C: 0, D: 1 } },
        { text: '実行可能で成果の出る施策', score: { A: 1, B: 0, C: 3, D: 1 } },
        { text: '業界の最新トレンドと知見', score: { A: 0, B: 1, C: 1, D: 3 } },
      ],
    },
    {
      id: 'q4',
      ...
      options: [
        { text: 'クライアントが自走できるようになる', score: { A: 3, B: 0, C: 1, D: 0 } },
        { text: '明確な経営戦略が確立される', score: { A: 0, B: 3, C: 0, D: 1 } },
        { text: '売上・利益が目に見えて向上する', score: { A: 0, B: 1, C: 3, D: 0 } },
        { text: '業界をリードする仕組みができる', score: { A: 0, B: 1, C: 0, D: 3 } },
      ],
    },
  ],
  results: [

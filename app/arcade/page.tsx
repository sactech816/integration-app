...
// 固定のサンプルキャンペーンID（SQLで作成される）
const SAMPLE_CAMPAIGN_IDS = {
  slot: 'arcade-sample-slot',
  scratch: 'arcade-sample-scratch',
  fukubiki: 'arcade-sample-fukubiki',
  gacha: 'arcade-sample-gacha',
  login_bonus: 'arcade-sample-login-bonus',
  stamp_rally: 'arcade-sample-stamp-rally',
};

...
const allTools: ToolDef[] = [
  ...
  { name: '出欠メーカー', description: '飲み会・イベントの日程調整を簡単に。調整さん風の出欠表を無料で何度でも作成できます。', icon: Users, href: '/attendance', color: 'from-cyan-400 to-teal-600', bgColor: 'bg-cyan-50', textColor: 'text-cyan-600', features: ['ログイン不要', '無制限作成', 'リアルタイム'], genre: 'marketing', purpose: 'sell', personas: ['seminar'] },
  ...
  { name: 'LINE公式連携', description: 'LINE公式アカウントと連携してメッセージ配信。リッチメニュー・ステップ配信で顧客との関係を構築。', icon: MessageCircle, href: '/line', color: 'from-green-500 to-emerald-600', bgColor: 'bg-green-50', textColor: 'text-green-600', features: ['LINE連携', 'ステップ配信', 'PRO'], isPro: true, genre: 'marketing', purpose: 'nurture', personas: ['coach', 'seminar'] },
  // ゲーミフィケーション
  ...
  { name: '楽天キーワードリサーチ', description: '楽天市場の売れ筋商品・キーワードを調査。EC事業者のリサーチに最適。', icon: ShoppingCart, href: '/rakuten-research', color: 'from-rose-500 to-pink-600', bgColor: 'bg-rose-50', textColor: 'text-rose-600', features: ['売れ筋調査', 'キーワード分析', 'EC向け'], genre: 'research', purpose: 'research', personas: ['ec'] },
  ...
  { name: 'Kindleキーワードリサーチ', description: 'Kindle市場のベストセラー・キーワードを調査。出版戦略の立案をサポート。', icon: BookOpen, href: '/kindle-research', color: 'from-orange-500 to-amber-600', bgColor: 'bg-rose-50', textColor: 'text-rose-600', features: ['ベストセラー分析', 'キーワード調査', '出版戦略'], genre: 'research', purpose: 'research', personas: ['content'] },

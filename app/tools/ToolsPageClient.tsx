...
const allTools: ToolDef[] = [
  ...
  { name: 'ウェビナーLPメーカー', description: 'ウェビナー・オンラインセミナーの集客LPを簡単作成。申し込みフォーム付きで参加者管理も楽々。', icon: Video, href: '/webinar', color: 'from-indigo-400 to-violet-600', bgColor: 'bg-indigo-50', textColor: 'text-indigo-600', features: ['LP作成', '申込フォーム', '参加者管理'], genre: 'page', purpose: 'collect', personas: ['seminar'] },
  { name: 'ガイドメーカー', description: 'サイトに埋め込めるはじめかたガイドを簡単作成。外部サイトへの埋め込みにも対応します。', icon: Lightbulb, href: '/onboarding', color: 'from-indigo-400 to-blue-600', bgColor: 'bg-indigo-50', textColor: 'text-indigo-600', features: ['埋め込み対応', 'トリガー設定', 'PRO'], isPro: true, genre: 'page', purpose: 'sell', personas: ['startup'] },
  { name: 'ホームページメーカー', description: '複数ページのホームページを簡単作成。事業紹介サイトをノーコードで構築できます。', icon: Monitor, href: '/site', color: 'from-indigo-500 to-blue-700', bgColor: 'bg-indigo-50', textColor: 'text-indigo-600', features: ['マルチページ', 'ノーコード', 'レスポンシブ'], genre: 'page', purpose: 'awareness', personas: ['startup', 'coach', 'seminar'] },
  // 診断・クイズ
  ...
  { name: 'エンタメ診断メーカー', description: 'バズるエンタメ系診断コンテンツをAIで簡単作成。SNSで拡散される楽しい診断を作れます。', icon: PartyPopper, href: '/entertainment/create', color: 'from-emerald-400 to-green-600', bgColor: 'bg-emerald-50', textColor: 'text-emerald-600', features: ['AI自動生成', 'SNSバズ', 'エンタメ系'], genre: 'quiz', purpose: 'collect', personas: ['sns'] },
  // ライティング・制作
  { name: 'セールスライター', description: 'セールスレター・LP文章をAIで自動生成。売れるコピーライティングを誰でも簡単に作成できます。', icon: PenTool, href: '/salesletter', color: 'from-amber-500 to-orange-600', bgColor: 'bg-amber-50', textColor: 'text-amber-600', features: ['AI自動生成', '売れる文章', 'テンプレート'], genre: 'writing', purpose: 'sell', personas: ['coach', 'content', 'ec'] },
  { name: 'サムネイルメーカー', description: 'YouTube・ブログ・Kindle用のサムネイル画像をAIで自動生成。プロ品質のビジュアルを簡単に作成。', icon: Image, href: '/thumbnail', color: 'from-amber-400 to-yellow-600', bgColor: 'bg-amber-50', textColor: 'text-amber-600', features: ['AI自動生成', 'YouTube対応', 'PRO'], isPro: true, genre: 'writing', purpose: 'awareness', personas: ['startup', 'content', 'ec', 'sns'] },
  { name: 'SNS投稿メーカー', description: 'SNS投稿文をAIで自動生成。X・Instagram・Facebook等に最適な投稿を簡単作成。', icon: Send, href: '/sns-post', color: 'from-amber-500 to-orange-500', bgColor: 'bg-amber-50', textColor: 'text-amber-600', features: ['AI自動生成', 'SNS最適化', 'マルチ対応'], genre: 'writing', purpose: 'awareness', personas: ['startup', 'seminar', 'content', 'ec', 'sns'] },
  ...
  // 集客・イベント
  { name: '予約メーカー', description: 'ビジネス向け予約管理システム。スプレッドシート連動やExcelエクスポートで効率的な予約管理が可能。', icon: Calendar, href: '/booking', color: 'from-cyan-500 to-blue-600', bgColor: 'bg-cyan-50', textColor: 'text-cyan-600', features: ['カレンダー連携', 'Excel出力', '通知機能'], genre: 'marketing', purpose: 'sell', personas: ['coach', 'seminar'] },

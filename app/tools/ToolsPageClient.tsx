...
const allTools: ToolDef[] = [
  ...
  { name: 'HPメーカー', description: '複数ページのホームページを簡単作成。事業紹介サイトをノーコードで構築できます。', icon: Monitor, href: '/site', color: 'from-indigo-500 to-blue-700', bgColor: 'bg-indigo-50', textColor: 'text-indigo-600', features: ['マルチページ', 'ノーコード', 'レスポンシブ'], genre: 'page', purpose: 'awareness', personas: ['startup', 'coach', 'seminar'] },
  // 診断・クイズ

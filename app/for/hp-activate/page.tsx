...
export const metadata: Metadata = {
  ...
  description: '既存のホームページ・LPに「AIコンシェルジュ」と「ステップガイド」を埋め込むだけで、動きのなかったサイトが24時間自動で接客・案内するサイトに変わります。法人向け個別カスタマイズで導入。',
  keywords: [
    'ホームページ 活性化', 'HP 改善', 'AIチャットボット 埋め込み',
  ...
  openGraph: {
    ...
    description: 'コード1行で、既存HPが24時間自動接客するサイトに。AIコンシェルジュ＆ステップガイドを御社のHPに導入。',

...
function WebinarEditorContent() {
  ...
  if (!user) {
    return (
      <>
        <Header setPage={navigateTo} user={null} onLogout={handleLogout} setShowAuth={setShowAuth} currentService="webinar" />
        <LoginRequired toolName="ウェビナーLPメーカー" onLogin={() => setShowAuth(true)} />

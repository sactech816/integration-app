...
export const metadata: Metadata = {
  title: 'ステップメール（自動メール配信）【無料】| 集客メーカー',
  description:
    'ステップメールを無料で作成。シナリオ設計からメール配信まで自動化。見込み客を段階的にナーチャリングして成約率をアップ。集客を自動化しましょう。',
  keywords: ['ステップメール', '自動メール配信', 'メールマーケティング', '無料', 'ナーチャリング', 'シナリオメール', 'メール自動化'],
  openGraph: {
